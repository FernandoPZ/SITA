...
if(!isset($_SESSION['usuario'])){ // Verifica que el usuario no esta vacio
	...
	if($_SESSION['active']==true){ // Valida que la sesion este activa
		$usuario=$_SESSION["usuario"]; // Almacena el id de usuario
		$tipo=$_SESSION["tipo"]; // Almacena el tipo de usuario
		$foto=$_SESSION["foto"]; // Almacena el nombre de la foto del usuario
	}
}
?>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse">
					<ul class="navbar-nav me-auto">
						<?php if($_SESSION['tipo'] == 1){ ?> <!-- Valida solo para mostrar a los administradores -->
