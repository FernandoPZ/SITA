                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php
                                            //Paginador
                                            include "../config/conexion.php";
                                            $sql_formacion = mysqli_query($conexion, "SELECT COUNT(*) AS tr_formacion FROM formacion WHERE activo = 1 AND cve_docente = $idDoc"); // Cuenta y almacena todos los registros activos
                                            ...
                                            $query = mysqli_query($conexion, "SELECT * FROM formacion WHERE activo = 1 AND cve_docente = $idDoc ORDER BY cve_formacion ASC LIMIT $desde,$por_pagina;");
